const items = [
    {
        ...
        payPalBtn: `<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                        ...
                        <input type="hidden" name="hosted_button_id" value="TB5JUVDU8WTFJ">
                            <input type="hidden" name="on0" value="Options"><select name="os0" className:"select-price">
                                ...
                                <option value="shipping in EU by Post">item + shipping in EU by Post €46.99 EUR</option>
                                <option value="shipping in EU by Courier">item + shipping in EU by Courier €56.99 EUR</option>
                                <option value="shipping outside EU by Post">item + shipping outside EU by Post €57.99 EUR</option>
                                <option value="shipping outside EU by Courier">item + shipping outside EU by Courier €76.99 EUR</option>
                            </select>
        ...
        payPalPromo: `<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                        <input type="hidden" name="cmd" value="_s-xclick">
                        <input type="hidden" name="hosted_button_id" value="TB5JUVDU8WTFJ">
                            <input type="hidden" name="on0" value="Options"><select name="os0" className:"select-price">
                                <option value="personal pick up (no shipping)">item (no shipping incl.) €29.99 EUR</option>
    ...
    source: '/about-telurian-1/tdd-gallery',
    ...
    },
    {
        ...
        payPalBtn: `<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                        ...
                        <input type="hidden" name="on0" value="Options"></td></tr><tr><td><select name="os0">
                            ...
                            <option value="shipping in EU by Post">item + shipping in EU by Post €96.99 EUR</option>
        ...
        itemName: `TELLURIUM ARTWORK COLLECTOR'S EDITION`,
        ...
        delivery: 'See the shipping options at the end of this page!',
        source: '/about-telurian-1/tace-gallery',
        morePhotos: 'More photos',
        soldOut: true,
    },
    {
        ...
        payPalPromo: `<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                        <input type="hidden" name="cmd" value="_s-xclick">
                        <input type="hidden" name="hosted_button_id" value="QL2QCHJN2UE4N">
                        <table>
                        <select name="os0">
                            <option value="one time download link">one time download link €9.99 EUR</option>
                        </select> </td></tr>
                        </table>
                        <input type="hidden" name="currency_code" value="EUR">
                        <input class='buy-now' type="image" src="https://res.cloudinary.com/https-www-zebramusic-net/image/upload/v1612710144/buynowBtn_qpl4fq.png" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
...
const telurian2 = [
    {
        imgUrl: 'https://res.cloudinary.com/https-www-zebramusic-net/image/upload/v1640862005/T2_cover_vtvcak.jpg',
        alt: 'DIGITAL VERSION',
        payPalBtn: `<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                        <input type="hidden" name="cmd" value="_s-xclick">
                        <input type="hidden" name="hosted_button_id" value="B5CKHRFNJ872L">
        ...
        `,
        itemName: `DIGITAL VERSION`,
        itemDescription: ['The tracklist features  four parts (OPUS 1-4) listing 38 tracks from 48 artists, surfing the electronic', 'minimal music in every direction as the perfect soundtrack for your trips this new season!', 'The download link includes the graphics and the album in WAV format.'],
        delivery: `You'll receive a download link once PayPal confirms your payment.`,
        source: null,
        morePhotos: null,
        soldOut: false,
    ...
    {
        imgUrl: 'https://res.cloudinary.com/https-www-zebramusic-net/image/upload/v1640862011/AFIS_T2_ALBUM_website_gzm1um.jpg',
        alt: 'DELUXE 3D ARTBOOK GOLD EDITION DIGIPACK ',
        payPalBtn: `<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
        <input type="hidden" name="cmd" value="_s-xclick">
        <input type="hidden" name="hosted_button_id" value="B3W5SXYTVXR2C">
        <tr><td><input type="hidden" name="on0" value="Options"></td></tr><tr><td><select name="os0">
            <option value="personal pick up (no shipping)">personal pick up (no shipping) €49.00 EUR</option>
            <option value="shipping in Romania by Post">shipping in Romania by Post €54.00 EUR</option>
            <option value="shipping in Romania by Courier">shipping in Romania by Courier €56.00 EUR</option>
            <option value="shipping in EU by Post">shipping in EU by Post €66.00 EUR</option>
            <option value="shipping in EU by Courier">shipping in EU by Courier €76.00 EUR</option>
            <option value="shipping outside EU by Post">shipping outside EU by Post €77.00 EUR</option>
            <option value="shipping ouside EU by Courier">shipping ouside EU by Courier €96.00 EUR</option>
        </select> </td></tr>
        <input type="hidden" name="currency_code" value="EUR">
        <input class='buy-now' type="image" src="https://res.cloudinary.com/https-www-zebramusic-net/image/upload/v1612710144/buynowBtn_qpl4fq.png" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
        <img alt="" border="0" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1">
